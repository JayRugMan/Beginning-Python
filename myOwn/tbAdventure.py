...
def build_house():
    ...
    list_house = [room_0, room_1, room_2, room_3, room_4, room_5]
...
def main_display(list_room_names, int_in_which_room, list_directions,
                 int_facing_which_direction, str_what_you_see, str_feedback):
...
""".format(list_room_names[int_in_which_room],
