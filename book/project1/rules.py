...
class ListHeadingRule(Rule):
    """
    A heading for lists. Essentially, this is the same as the heading rule,
    but for when it does end with a ':'
    """
    type = 'heading3'
    def condition(self, block):
...
class ListItemRule(Rule):
    """
    A list item is a paragraph that bgins with a hyphen. As part of
